...
const contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "bb9ae5b0-9d95-4879-98f9-d04b0e5b186c");
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20
     bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto dark:bg-none'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
       I'd love to hear fromyou! If you have any questions, comments,or feedback, 
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        rounded-md bg-white md-6  dark:bg-darkHover/30 dark:border-white/90 ' name='message'></motion.textarea>
