      ...
      >
        <a href="#top">
          <Image
            ...
            alt="Logo"
            className="w-20 cursor-pointer mr-14 rounded"
          />
        </a>
        <ul
          className={`hidden md:flex items-center
           gap-6 lg:gap-10 rounded-full px-12 py-3 ${
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            href="#contact"
          >
            Hire me <Image alt="icon" src={isDarkMode? assets.arrow_icon_dark:assets.arrow_icon} className="w-3" />
          </a>
